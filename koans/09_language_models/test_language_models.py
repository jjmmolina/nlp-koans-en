...
ADVERTENCIA: Estos tests descargan models GRANDES y pueden tardar mucho.
...
class TestBasicGeneratestion:
    ...
    def test_generated_text_contains_prompt(self):
        """Test: Text generado contiene el prompt"""
...
class TestMultipleCompletions:
    ...
    def test_generate_multiple_completions(self):
        """Test: Generatesr múltiples completados"""
...
class TestTemperature:
    ...
    def test_generate_with_temperature_low(self):
        """Test: Generatesción con temperatura baja (conservador)"""
    ...
    def test_generate_with_temperature_high(self):
        """Test: Generatesción con temperatura alta (creativo)"""
...
class TestPerplexity:
    ...
    def test_calculate_perplexity_natural_text(self):
        """Test: Perplejidad de text natural"""
    ...
    def test_natural_text_lower_perplexity_than_random(self):
        """Test: Text natural tiene menor perplejidad que aleatorio"""
        ...
        # El text natural debería tener menor perplejidad
        # (pero esto puede fallar con models pequeños)
...
class TestPromptEngineering:
    ...
    def test_prompt_engineering_template(self):
        """Test: Createsr template de prompt"""
    ...
    def test_prompt_template_includes_examples(self):
        ...
        # Al menos uno from the ejemplos debe estar
        assert any(ex.split(" -> ")[0] in result for ex in examples)


class TestGeneratestionComparison:
...
class TestRealWorldExamples:
    ...
    def test_code_documentation_generation(self):
        """Test: Generatesr documentación de código"""
    ...
    def test_story_generation(self):
        """Test: Generatesr historia corta"""
